...
and \verb|variables|,
and the lists \verb|target_municipalities| and \verb|years|.
...
however, one should not use overlapping ACS5 datasets!
\href{
...
This will change.
With modularity in mind, we should move to \red{separate calls for all different classes} of data.
E.g., a call for population, a call for housing age, a call for heating fuel, etc.
...
\red{Need to learn more before writing this up.}

\[
\text{\blue{Portfolio}} \longleftarrow 
\text{Instant App} \longleftarrow 
\text{Web Map} \longleftarrow 
\text{Feature Layer} 
\]
